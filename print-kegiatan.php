...
<body><br><br><br>
	...
	if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter
		...
		if($filter == '1'){ // Jika filter nya 1 (per tanggal)
			...
			echo 'Ket : Laporan Kegiatan Tanggal '.$tgl.'<br /><br />';
			...
			echo "Yth. Pimpinan Kusuma Jaya Batik<br>";
			echo "Hal : Laporan Keuangan<br>";
			echo 'Ket : Laporan Kegiatan Bulan '.$nama_bulan[$_GET['bulan']].' '.$_GET['tahun'].'<br /><br />';
			...
			echo "Yth. Pimpinan Kusuma Jaya Batik<br>";
			echo "Hal : Laporan Keuangan<br>";
			echo 'Ket : Laporan Kegiatan Tahun '.$_GET['tahun'].'<br /><br />';
		...
		?>
			...
			echo "Yth. Pimpinan Kusuma Jaya Batik<br>";
			echo "Hal : Laporan Keuangan<br>";
			echo 'Ket : Semua Data Kegiatan<br /><br />';
	...
	<tr>
		...
		<th style="text-align: center;">Jumlah Dana (Rp.)</th>
		<th style="text-align: center;">Lokasi Pelaksanaan</th>
...
<!-- 		<th>Barang</th>
	...
	if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
		while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
			...
			echo "<tr>";
			// echo "<td>".$tgl."</td>";
			echo "<td style='text-align : center;'>".$data['nama_kegiatan']."</td>";
			echo "<td style='text-align : center;'>".$tgl."</td>";
			echo "<td style='text-align : right;'>"."".number_format($data['jumlah'],2,',','.')."</td>";
			echo "<td style='text-align : center;'>".$data['lokasi']."</td>";
 ...
 //        ?><br><?php
	...
	<div class="">
		<br>
		<p>Laporan Keuangan ini dibuat dengan sesungguhnya untuk dipergunakan sebagaimana mestinya. Laporan ini dibuat oleh <?=$_SESSION['nama']?> pada tanggal <?php echo (new \DateTime())->format('d-m-Y');?> , dengan Total Dana Kebutuhan Kegiatan  Rp. <?php echo number_format($ttl,2,',','.') ?> ,- </p>
	</div>
<br><br></div>
...
$pdf->WriteHTML($html);
$pdf->Output('Laporan Kegiatan.pdf', 'D');
?>
